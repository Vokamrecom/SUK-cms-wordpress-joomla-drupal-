...
$bg_contact = $this->getParam('bg_contact');
if ($bg_contact) {
    $this->addStyleDeclaration('.bg-contact  {
     background: url("' . JUri::base() . $bg_contact . '") no-repeat scroll center top rgba(0, 0, 0, 0);
...
$opacity = $this->getParam('set_opacity');
if ($opacity) {
    $this->addStyleDeclaration('
    #homepage .overlay-color, .offer .overlay-color, .features .overlay-color, #contact .overlay-color  {
...
$this->addScript(PLAZART_TEMPLATE_REL . '/js/prettyPhoto.js');
$this->addScript(PLAZART_TEMPLATE_REL . '/js/appear.js');
$this->addScript(PLAZART_TEMPLATE_REL . '/js/nav.js');
$this->addScript(PLAZART_TEMPLATE_REL . '/js/easing.min.js');
$this->addScript(PLAZART_TEMPLATE_REL . '/js/countTo.js');
$this->addScript(PLAZART_TEMPLATE_REL . '/js/custom.js');
?>
