...
<div class="TzMultipurpose social-icons tz-container-fluid <?php echo $moduleclass_sfx; ?>">
    <?php
                ...
                if($n != 'group' && $a == $v_id_f){
                    if(is_numeric($a)) {
                        if($value != "") {
                            ...
                            if($type_field != 'link') {
                                ?><div class="icon-wrap <?php echo $field->title;?>">
                                <?php
                                if($type_field == 'image'){
                                ...
                                if($i == 1) {
                                    ...
                                    echo '<div class="icon-wrap"><a class="facebook" '.$link_option -> link_o.' href="'.$link_option -> link.'"><i class="'.$link_option -> title_link.'" aria-hidden="true"></i>
</a></div>';
                                }
                            }
                        }
