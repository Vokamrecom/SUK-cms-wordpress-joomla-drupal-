...
<div class="corner-date">
    <?php echo JText::sprintf(JHtml::_('date', $this->item->created, JText::_('d'))); ?><br/>
    <span>
...
<ul class="datas">
    ...
    <?php if ($params->get('show_parent_category') && $this->item->parent_slug != '1:root') : ?>
        <li class="TzArticleParentCategory">
    ...
    <?php if ($params->get('tz_show_count_comment', 1) == 1): ?>
        <li class="comment">
            ...
            <?php if ($params->get('tz_comment_type') == 'jcomment'): ?>
                ...
                ?>
            <?php endif; ?>
            <?php echo JText::_('TPL_TZ_COMMENT_COUNT'); ?>
        </li>
    <?php endif; ?>

    <?php if ($params->get('show_publish_date')) : ?>
        <li class="TZPublished">
    ...
    <?php if ($params->get('show_author', 1) && !empty($this->item->author)) : ?>
        <li class="TzCreatedby">
            ...
            <?php if ($params->get('link_author') == true): ?>
                ...
                ?>
                <?php echo JText::sprintf(JHtml::_('link', JRoute::_($cntlink), $author, $target)); ?>
            <?php else: ?>
                <cite>
                    <?php echo JText::sprintf('TZ_AUTHOR',$author); ?>
                </cite>
            <?php endif; ?>
        </li>
    <?php endif; ?>
