        ...
        <div class="span8 form-horizontal">
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="text_area" type="text" name="url" id="url" size="80" placeholder="<?php echo JText::_('COM_EASYFRONTENDSEO_URL'); ?>" value="<?php echo $this->entry->url; ?>"/>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <input class="text_area" type="text" name="title" id="title" size="80" placeholder="<?php echo JText::_('COM_EASYFRONTENDSEO_TITLE'); ?>" maxlength="<?php echo $this->charactersLength['title']; ?>" value="<?php echo htmlspecialchars($this->entry->title); ?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea class="text_area" rows="4" cols="140" placeholder="<?php echo JText::_('COM_EASYFRONTENDSEO_DESCRIPTION'); ?>" maxlength="<?php echo $this->charactersLength['description']; ?>" id="description" name="description"><?php echo htmlspecialchars($this->entry->description); ?></textarea>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="text_area" type="text" name="keywords" id="keywords" size="80" maxlength="255" placeholder="<?php echo JText::_('COM_EASYFRONTENDSEO_KEYWORDS'); ?>" value="<?php echo htmlspecialchars($this->entry->keywords); ?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="text_area" type="text" name="generator" id="generator" size="80" placeholder="<?php echo JText::_('COM_EASYFRONTENDSEO_GENERATOR'); ?>" maxlength="255" value="<?php echo htmlspecialchars($this->entry->generator); ?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="" id="robots" name="robots">
                            <?php foreach ($this->robotsArray as $robots_value) : ?>
