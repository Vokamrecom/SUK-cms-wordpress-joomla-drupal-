...
$doc->addScript(JUri::base(true) . '/templates/' . JFactory::getApplication()->getTemplate() . '/js/resizeimage.js');
$doc->addScript(JUri::base(true) . '/templates/' . JFactory::getApplication()->getTemplate() . '/js/prettyPhoto.js');
$markup = '';
$markup .= '<div class="pp_pic_holder"><div class="ppt"><\/div><div class="pp_top"><div class="pp_left"><\/div><div class="pp_middle"><\/div><div class="pp_right"><\/div><\/div>';
$markup .= '<div class="pp_content_container"><div class="pp_left"><div class="pp_right"><div class="pp_content"><div class="pp_loaderIcon"><\/div><div class="pp_fade"> ';
$markup .= '<a href="#" class="pp_expand" title="Expand the image">Expand<\/a><div class="pp_hoverContainer"><a class="pp_next" href="#">next<\/a><a class="pp_previous" href="#">previous<\/a><\/div><div id="pp_full_res"><\/div><div class="pp_details"><div class="pp_nav">';
$markup .= '<a href="#" class="pp_arrow_previous">Previous<\/a><p class="currentTextHolder">0/0<\/p><a href="#" class="pp_arrow_next">Next<\/a><\/div><p class="pp_description">{pp_social}<\/p><a class="pp_close" href="#">Close<\/a><\/div><\/div><\/div>';
$markup .= '<\/div><\/div><\/div><div class="pp_bottom"><div class="pp_left"><\/div><div class="pp_middle"><\/div><div class="pp_right"><\/div><\/div><\/div><div class="pp_overlay"><\/div>';
$gallery_markup = '';
...
<?php if ($this->listsArticle): ?>
    ...
    <div id="TzContent" class="TzContent <?php echo $this->pageclass_sfx; ?>">
    ...
    <div id="tz_options" class="clearfix">
        <?php if ($params->get('tz_show_filter', 1)): ?>
            <div class="option-combo">
                ...
                <div id="filter" class="option-set clearfix center-block no-float" data-option-key="filter">
                     <a href="#show-all" data-option-value="*"
                       class="btn btn-small selected"><i class="fa fa-th-large"></i><?php echo JText::_('COM_TZ_PORTFOLIO_SHOW_ALL'); ?></a>
